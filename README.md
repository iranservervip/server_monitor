...
1.  **Download the script:**
    ```bash
    wget [https://raw.githubusercontent.com/iranservervip/server_monitor/main/monitor.sh](https://raw.githubusercontent.com/iranservervip/server_monitor/main/monitor.sh)
    ```
